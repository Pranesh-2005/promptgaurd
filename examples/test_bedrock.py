"""promptgaurd + AWS Bedrock (boto3 Converse API).
...
from promptgaurd.responses import render_block_message
from _common import ATTACK, BENIGN, load_dotenv, make_gaudrial, show
